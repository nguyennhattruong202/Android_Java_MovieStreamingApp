...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showsBannerList.add(new BannerMovies(1, "7 nụ cười xuân", "https://img.hplus.com.vn/728x409/banner/2018/04/23/120828-7-nu-cuoi-xuan-800.jpg", ""));
        showsBannerList.add(new BannerMovies(2, "Người bí ẩn", "https://upload.wikimedia.org/wikipedia/vi/thumb/1/1c/Nguoi_bi_an_%28logo%29.jpg/300px-Nguoi_bi_an_%28logo%29.jpg", ""));
        showsBannerList.add(new BannerMovies(3, "Ơn giời! Cậu đây rồi!", "https://upload.wikimedia.org/wikipedia/vi/f/f1/C%E1%BA%A3nh_t%E1%BB%B1a_%C4%91%E1%BB%81_c%E1%BB%A7a_%C6%A0n_gi%E1%BB%9Di_c%E1%BA%ADu_%C4%91%C3%A2y_r%E1%BB%93i.png", ""));
        ...
        showsBannerList.add(new BannerMovies(5, "Siêu trí tuệ Việt Nam", "https://image.thanhnien.vn/w980/Uploaded/2022/wpdhnwejw/2020_11_14/viechannelhtv2photosgioithieusieutrituevietnam25_knjh.jpg", ""));
        ...
        kidsBannerList.add(new BannerMovies(1, "Kính vạn hoa", "https://kenh14cdn.com/thumb_w/660/2019/10/3/156663348895513300-1570113053534655915637.jpg","https://media.geeksforgeeks.org/wp-content/uploads/20201217163353/Screenrecorder-2020-12-17-16-32-03-350.mp4"));
        kidsBannerList.add(new BannerMovies(2, "Tom and jerry", "https://o.rada.vn/data/image/2021/04/15/Bo-phim-tom-and-jerry.jpg",""));
        kidsBannerList.add(new BannerMovies(3, "Mèo Oggy", "https://teddy.vn/wp-content/uploads/2019/04/meo-oggy-va-nhung-chu-gian-tinh-nghich-8-min.jpg",""));
        ...
        kidsBannerList.add(new BannerMovies(2, "Conan, thám tử lừng danh", "https://gamek.mediacdn.vn/133514250583805952/2021/10/13/photo-1-16341006858381776570478.jpeg",""));
